...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate episodes from countdown dataset")
    parser.add_argument("--model_path", type=str, default="data/Qwen2.5-3B-Instruct",
                        help="Path to the model directory")
    parser.add_argument("--data_path", type=str, default="data/Countdown-Tasks-3to4",
    ...
    parser.add_argument("--num_answers", type=int, default=4,
                        help="Number of answers to generate per question")
    parser.add_argument("--max_gen_len", type=int, default=512,
                        help="Maximum length of generated responses")
    parser.add_argument("--resume", action="store_true",
                        help="Resume from the last processed batch")
