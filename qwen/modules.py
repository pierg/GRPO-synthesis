...
class Attention(nn.Module):
    ...
    def __init__(self, args: Qwen2Config):
        ...
        self.q_proj = nn.Linear(
            args.hidden_size, args.num_attention_heads * self.head_dim, bias=True
        )
        self.k_proj = nn.Linear(
            args.hidden_size, args.num_key_value_heads * self.head_dim, bias=True
        )
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, layer_id: int, args: Qwen2Config):
        ...
        self.mlp = FeedForward(
            dim=args.hidden_size, intermediate_size=args.intermediate_size
        )
